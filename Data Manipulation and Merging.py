...
Furthermore, it enriches the existing data model includes Cost and Revenue data, 
Program Marketed Tonnes, and Finance Program Data, by adding the geolocation data (lot, long) of each program code.   
"""
